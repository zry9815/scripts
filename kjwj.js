...
const kjwjqdurlArr = [], kjwjqdhdArr = [], kjwjqdbodyArr = [], kjwjqdcount = ''
...
//POST
//获取ck  https://www.kejiwanjia.com/wp-json/b2/v1/userMission
function kjwjqdck() {
...
function kjwjqd(timeout = 0) {
    return new Promise((resolve) => {
        ...
        let url = {
            ...
            body: `earer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvd3d3Lmtlaml3YW5qaWEuY29tIiwiaWF0IjoxNjMzODYxODY3LCJuYmYiOjE2MzM4NjE4NjcsImV4cCI6MTYzNDYzOTQ2NywiZGF0YSI6eyJ1c2VyIjp7ImlkIjoiNDA0OCJ9fX0.M-XMzbf4-rGoKvFDXwkFSntH-GOYjleYY_Iwb0833As`,
        }
